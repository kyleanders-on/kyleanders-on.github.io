...
def fetch_water_level_data(start_date, end_date, station_id, ts_product):
    ...
    API documentation: https://api-spine.azure.cloud-nuage.dfo-mpo.gc.ca/swagger-ui/index.html
    ...
    """
    base_url = f"https://api.iwls-sine.azure.cloud-nuage.dfo-mpo.gc.ca/api/v1/stations/{station_id}/data"
